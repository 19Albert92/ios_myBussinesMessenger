...
internal enum VectorL10n {
  ...
  /// You didn't allow My Business to access your local contacts
  ...
  /// This works with My Business and other cross-signing capable Matrix clients.
  ...
  /// My Business now supports end-to-end encryption but you need to log in again to enable it.\n\nYou can do it now or later from the application settings.
  ...
  /// Please launch My Business on another device that can decrypt the message so it can send the keys to this session.
  ...
  /// Sorry. This action is not available on My Business iOS yet. Please use another Matrix client to set it up. My Business iOS will use it.
  ...
  /// Receive incoming calls on your lock screen. See your My Business calls in the system's call history. If iCloud is enabled, this call history will be shared with Apple.
  ...
  /// My Business is a new type of messenger and collaboration app that:\n\n1. Puts you in control to preserve your privacy\n2. Lets you communicate with anyone in the Matrix network, and even beyond by integrating with apps such as Slack\n3. Protects you from advertising, datamining, backdoors and walled gardens\n4. Secures you through end-to-end encryption, with cross-signing to verify others\n\nMy Business is completely different from other messaging and collaboration apps because it is decentralised and open source.\n\nMy Business lets you self-host - or choose a host - so that you have privacy, ownership and control of your data and conversations. It gives you access to an open network; so you’re not just stuck speaking to other My Business users only. And it is very secure.\n\nMy Business is able to do all this because it operates on Matrix - the standard for open, decentralised communication. \n\nMy Business puts you in control by letting you choose who hosts your conversations. From the My Business app, you can choose to host in different ways:\n\n1. Get a free account on the matrix.org public server\n2. Self-host your account by running a server on your own hardware\n3. Sign up for an account on a custom server by simply subscribing to the My Business Matrix Services hosting platform\n\nWhy choose My Business?\n\nOWN YOUR DATA: You decide where to keep your data and messages. You own it and control it, not some MEGACORP that mines your data or gives access to third parties.\n\nOPEN MESSAGING AND COLLABORATION: You can chat with anyone else in the Matrix network, whether they’re using My Business or another Matrix app, and even if they are using a different messaging system of the likes of Slack, IRC or XMPP.\n\nSUPER-SECURE: Real end-to-end encryption (only those in the conversation can decrypt messages), and cross-signing to verify the devices of conversation participants.\n\nCOMPLETE COMMUNICATION: Messaging, voice and video calls, file sharing, screen sharing and a whole bunch of integrations, bots and widgets. Build rooms, communities, stay in touch and get things done.\n\nEVERYWHERE YOU ARE: Stay in touch wherever you are with fully synchronised message history across all your devices and on the web at https://My Business.io/app.
